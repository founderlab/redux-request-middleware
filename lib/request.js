  ...
  return function requestMiddleware() {
    return function (next) {
      return function (_action) {
        var _options$extractReque = options.extractRequest(_action);

        var request = _options$extractReque.request;
        var callback = _options$extractReque.callback;
        var parseResponse = _options$extractReque.parseResponse;
        var action = _options$extractReque.action;
